...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const artistsData = {
        ...
        666: {
            ...
            price: "5000₽",
            time: "22:00 - 06:00",
            desc: "Финальная точка сезона. День, когда реальность NOLLY P1LS достигнет своего пика. Имена артистов будут открываться каждый час. В этот день владелец клуба празднует свое день рождения, FREE Bar для Ladies",
